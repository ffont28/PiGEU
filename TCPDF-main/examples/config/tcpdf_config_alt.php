 ...
 */
define ('PDF_HEADER_LOGO', 'logo-unimi.jpg');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'CERTIFICAZIONE DI CARRIERA');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Servizi di Segreteria ONLINE\nPiGEU - Piattaforma per la Gestione deli Esami Universitari");
