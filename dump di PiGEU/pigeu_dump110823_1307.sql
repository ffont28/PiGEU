...
-- Started on 2023-08-11 13:07:37 CEST
...
--
-- TOC entry 255 (class 1255 OID 16887)
-- Name: carriera_completa_esami_sostenuti(character varying); Type: FUNCTION; Schema: public; Owner: fontanaf
--

CREATE FUNCTION public.carriera_completa_esami_sostenuti(s character varying) RETURNS TABLE(studente character varying, codins character varying, nomins character varying, voto smallint, data date)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.carriera_completa_esami_sostenuti(s character varying) OWNER TO fontanaf;

--
-- TOC entry 254 (class 1255 OID 16886)
-- Name: carriera_completa_tutti(character varying); Type: FUNCTION; Schema: public; Owner: fontanaf
--

CREATE FUNCTION public.carriera_completa_tutti(s character varying) RETURNS TABLE(studente character varying, codins character varying, nomins character varying, voto character varying, data character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.carriera_completa_tutti(s character varying) OWNER TO fontanaf;
...
SELECT pg_catalog.setval('public.studente_matricola_seq', 97, true);
...
--
-- TOC entry 3363 (class 2606 OID 16836)
...
-- Completed on 2023-08-11 13:07:37 CEST
