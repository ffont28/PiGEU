...
if(isset($_POST['submit'])) {
    ...
    $cartella = $_SERVER['DOCUMENT_ROOT']."/photos"."<br>";
    echo $cartella;

    if (is_writable($cartella)) {
        echo "La cartella è scrivibile.";
    } else {
    ...
    $newFileName = $_SESSION['username'] . uniqid() . '.' . $extension;
            ...
            echo $originalFileName."<br>".$extension."<br>".$newFileName."<br>";
   ...
   echo "<br><br><br>";
//    if (copy($uploadedFile, $_SERVER['DOCUMENT_ROOT']. '/' .$targetFile)) {
...
//    }
    ...
    echo  "  ". $_FILES["fileToUpload"]["tmp_name"]." -------   " . $_SERVER['DOCUMENT_ROOT'].'/'.$targetFile;
